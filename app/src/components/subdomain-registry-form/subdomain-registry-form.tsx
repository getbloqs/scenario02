...
@Component({
    tag: 'subdomain-registry-form' ,
    styleUrl : 'subdomain-registry-form.scss'
})
export class SubdomainRegistryForm {
    ...
    save() {
        window['subdomainRegistry'].createRegistration(this.name, this.link).then(() => {                        
            this.close();
        }).catch(() => {
            this.error = true;
        });        
    ...
    render() {
        return (
            <span>
                <button onClick={() => { this.open = true; }} class="btn btn-primary">Create Registration</button>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                {this.error
                                    ? <div class="alert alert-danger" role="alert">There is an error in your registration, please check your inputs.</div>
                                    : ""
                                }
